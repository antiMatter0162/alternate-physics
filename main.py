...
if model_to_use == "1":
    ...
    print("Using model 3")
    velocity, time, acceleration = physics_laws_3.get_velocity(parameters["initial_conditions"]["acceleration"], 0.01, parameters["initial_conditions"]["velocity"], parameters["number_of_steps"], parameters["simulation_parameters"]["mass"] * parameters['initial_conditions']['acceleration'], parameters["simulation_parameters"]["mass"])
    position = physics_laws_3.get_position(velocity, 0.01, parameters["initial_conditions"]["position"], parameters["number_of_steps"])
